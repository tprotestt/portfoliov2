                          ...
                          <form action="forms/contact.php" method="post" role="form" className="php-email-form">
                            <div className="row">
                              ...
                              <div className="col-md-12 text-center">
                                <button type="submit" className="button button-a button-big button-rouded">Send</button>
                              </div>
                            </div>
                          </form>
                        </div>
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="more-info">
                          ...
                          <ul className="list-ico">
                            <li><span className="bi bi-geo-alt" /> Norfolk, VA</li>
                            <li><span className="bi bi-phone" /> (757) 641-4470</li>
                            <li><span className="bi bi-envelope" /> brennansbunch@gmail.com</li>
                          </ul>
                        </div>
